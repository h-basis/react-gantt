...
var GanttStore = /*#__PURE__*/function () {
  function GanttStore(_ref) {
    ...
    var sightConfig = customSights.length ? customSights[0] : viewTypeList[0];
  ...
  _createClass(GanttStore, [{
    ...
    value: function handleResizeTableWidth(width) {
      ...
      this.viewWidth = this.width - this.tableWidth; // if (width <= this.totalColumnWidth) {
      //   this.tableWidth = width
      //   this.viewWidth = this.width - this.tableWidth
      // }
...
var TaskBar = function TaskBar(_ref) {
  ...
  var _useContext = useContext(context),
      ...
      showTaskBarTotalDays = _useContext.showTaskBarTotalDays;
  ...
  })))), (allowDrag || disabled || showTaskBarTotalDays) && /*#__PURE__*/React.createElement("div", {
    className: "".concat(prefixClsTaskBar, "-label"),
    style: {
      left: width / 2 - 10
    }
  }, getDateWidth(translateX + width + moveCalc, translateX), "\u65E5"), (stepGesture === 'moving' || allowDrag || alwaysShowTaskBar) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
...
var ScrollBar$1 = observer(ScrollBar);
...
var GanttComponent = function GanttComponent(props) {
  var data = props.data,
      ...
      _props$showTaskBarTot = props.showTaskBarTotalDays,
      showTaskBarTotalDays = _props$showTaskBarTot === void 0 ? true : _props$showTaskBarTot,
      unit = props.unit,
      onRow = props.onRow,
  ...
  var ContextValue = React.useMemo(function () {
    return {
      ...
      showTaskBarTotalDays: showTaskBarTotalDays,
      onRow: onRow,
  ...
  }, [store, getBarColor, showBackToday, showUnitSwitch, showTaskBarTotalDays, onRow, tableIndent, expandIcon, renderBar, renderInvalidBar, renderGroupBar, onBarClick, tableCollapseAble, renderBarThumb, scrollTop, alwaysShowTaskBar, renderLeftText, renderRightText, onExpand]);
...
export { GanttComponent as default };
